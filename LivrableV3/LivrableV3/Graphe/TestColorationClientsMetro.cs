    ...
    public class TestColorationClientsMetro
    {
        ...
        public static void TesterColorationClientsMetro(ConnexionBDD connexionBDD, Graphe<int> grapheMetro)
        {
            try
            {
                ...
                // recupere les clients et leurs stations
                ...
                while (readerClients.Read())
                {
                    ...
                    // cherche la station dans le graphe du metro
                    ...
                    {
                        // cree un noeud pour le client avec les coordonnees de la station
                ...
                // recupere les cuisiniers et leurs stations
                ...
                // ajoute les cuisiniers au graphe
                while (readerCuisiniers.Read())
                {
                    ...
                    if (stationMetro != null)
                    {
                        // cree un noeud pour le cuisinier avec les coordonnees de la station
                ...
                // recupere les commandes pour creer les liens
                ...
                // ajoute les liens entre clients et cuisiniers
